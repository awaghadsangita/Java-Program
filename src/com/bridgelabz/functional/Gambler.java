...
public class Gambler {
	public static void main(String[] args)
	{
		...
		System.out.println("Percentage of match win :" +utility.calculatePercentage(mBets, mNumberOfTime));
		System.out.println("Percentage of match win :" +(100f-utility.calculatePercentage(mBets, mNumberOfTime)));
